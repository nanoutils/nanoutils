...
|                 |       |      +6.41% |       -0.07% |        -0.39% |
| --------------- | ----- | ----------- | ------------ | ------------- |
| map             | nano  |      0.10ms |       0.86ms |        7.72ms |
|                 | ramda |      0.09ms |       1.67ms |       14.01ms |
|                 | diff  |     +0.01ms |      -0.81ms |       -6.30ms |
|                 |       |     +12.25% |      -93.82% |       -81.58% |
| --------------- | ----- | ----------- | ------------ | ------------- |
| mapAccum        | nano  |      0.12ms |       0.91ms |        7.78ms |
|                 | ramda |      0.42ms |       2.53ms |       32.48ms |
|                 | diff  |     -0.31ms |      -1.62ms |      -24.71ms |
|                 |       |    -258.37% |     -178.38% |      -317.71% |
| --------------- | ----- | ----------- | ------------ | ------------- |
| mapAccumRight   | nano  |      0.14ms |       1.12ms |       10.26ms |
|                 | ramda |      0.52ms |       8.22ms |       92.55ms |
|                 | diff  |     -0.38ms |      -7.11ms |      -82.29ms |
|                 |       |    -274.68% |     -636.20% |      -802.26% |
| --------------- | ----- | ----------- | ------------ | ------------- |
...
|                 |       |     +32.50% |       -8.77% |       -77.78% |
| --------------- | ----- | ----------- | ------------ | ------------- |
| splitEvery      | nano  |      0.39ms |       3.06ms |       80.85ms |
|                 | ramda |      0.56ms |       5.57ms |      125.31ms |
|                 | diff  |     -0.17ms |      -2.51ms |      -44.46ms |
|                 |       |     -44.13% |      -82.11% |       -54.98% |
| --------------- | ----- | ----------- | ------------ | ------------- |
...
| --------- | ----- | -------- | --------- | --------- |
| aperture  | nano  |   0.03ms |    0.40ms |   82.26ms |
|           | ramda |   0.02ms |    0.35ms |   82.17ms |
|           | diff  |  +0.01ms |   +0.05ms |   +0.09ms |
|           |       |  +48.95% |   +14.98% |    +0.10% |
| --------- | ----- | -------- | --------- | --------- |
...
|             |       |  -44.59% | -491.49% |  -21.86% |
| ----------- | ----- | -------- | -------- | -------- |
| intersperse | nano  |   0.03ms |   0.04ms |   1.49ms |
|             | ramda |   0.04ms |   0.18ms |   6.31ms |
|             | diff  |  -0.01ms |  -0.14ms |  -4.82ms |
|             |       |  -31.06% | -348.23% | -323.62% |
| ----------- | ----- | -------- | -------- | -------- |
...
|             |       |  -87.69% | +110.09% |  +99.18% |
| ----------- | ----- | -------- | -------- | -------- |
| transpose   | nano  |   0.15ms |   0.43ms |  19.93ms |
|             | ramda |   0.12ms |   0.82ms |  27.77ms |
|             | diff  |  +0.04ms |  -0.39ms |  -7.83ms |
|             |       |  +30.94% |  -90.10% |  -39.29% |
| ----------- | ----- | -------- | -------- | -------- |
...
| ------- | ----- | -------- | -------- | ---------- |
| xprod   | nano  |   0.01ms |   0.13ms |   214.29ms |
|         | ramda |   0.01ms |   0.17ms |   263.54ms |
|         | diff  |  +0.00ms |  -0.04ms |   -49.24ms |
|         |       |   +8.68% |  -27.31% |    -22.98% |
| ------- | ----- | -------- | -------- | ---------- |
