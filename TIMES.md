...
| ----------- | ----- | -------- | -------- | --------- |
| allPass     | nano  |   0.19ms |   0.98ms |   10.32ms |
|             | ramda |   4.57ms |  41.19ms |  791.72ms |
|             | diff  |  -4.37ms | -40.20ms | -781.40ms |
|             |       |  -95.80% |  -97.62% |   -98.70% |
| ----------- | ----- | -------- | -------- | --------- |
...
|             |       |  -80.38% |   +2.21% |   +14.06% |
| ----------- | ----- | -------- | -------- | --------- |
| fromPairs   | nano  |   1.29ms |   7.62ms |   96.12ms |
|             | ramda |   0.54ms |   6.85ms |   89.66ms |
|             | diff  |  +0.74ms |  +0.77ms |   +6.46ms |
|             |       | +136.66% |  +11.28% |    +7.20% |
| ----------- | ----- | -------- | -------- | --------- |
...
|             |       |  +27.01% |   +4.59% |    -1.75% |
| ----------- | ----- | -------- | -------- | --------- |
| partition   | nano  |   0.10ms |   0.80ms |    6.91ms |
|             | ramda |   0.13ms |   0.63ms |    6.55ms |
|             | diff  |  -0.03ms |  +0.17ms |   +0.36ms |
|             |       |  -25.52% |  +27.14% |    +5.57% |
| ----------- | ----- | -------- | -------- | --------- |
| pickAll     | nano  |   1.45ms |  10.76ms |   81.65ms |
|             | ramda |   0.96ms |   9.88ms |   71.14ms |
|             | diff  |  +0.49ms |  +0.88ms |  +10.51ms |
|             |       |  +51.37% |   +8.95% |   +14.77% |
| ----------- | ----- | -------- | -------- | --------- |
| prepend     | nano  |   0.10ms |   1.16ms |   11.50ms |
|             | ramda |   0.14ms |   2.51ms |   41.98ms |
|             | diff  |  -0.04ms |  -1.35ms |  -30.48ms |
|             |       |  -26.42% |  -53.88% |   -72.60% |
| ----------- | ----- | -------- | -------- | --------- |
...
| Method  | Lib   |    1000 |   10000 |  100000 |
| ------- | ----- | ------- | ------- | ------- |
| groupBy | nano  |  0.29ms |  0.68ms |  3.41ms |
|         | ramda |  0.32ms |  0.72ms | 12.14ms |
|         | diff  | -0.03ms | -0.04ms | -8.74ms |
|         |       | -10.84% |  -6.00% | -71.95% |
| ------- | ----- | ------- | ------- | ------- |
