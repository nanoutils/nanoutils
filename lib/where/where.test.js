import where from '../../cjs/where'

it('returns true if all functions in spec, that matches the same key returns true', () => {
...
it('matches from only own properties', () => {
  const spec = {
    a: x => x === 2,
    b: x => x % 2 === 0
  }
