...
import slice from '../../cjs/slice'

it('accepts exact 3 arguments', () => {
  expectNumberOfArgs(slice, 3, [1, 2, [1, 2, 3]])
})

it('accepts 3 arguments, supports a curried version, returns a sliced array', () => {
...
it('returns nothing if from and/or to values are NaN', () => {
  const from = 1
  const to = 3
